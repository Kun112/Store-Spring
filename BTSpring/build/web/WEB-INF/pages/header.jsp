<%-- 
    Document   : header
    Created on : Jun 4, 2017, 6:28:43 PM
    Author     : Anh Quan
--%>
                        ...
                        <div class="col-sm-6">
                            <div class="contactinfo">
                                <ul class="nav nav-pills">
                                    <li><a href="#"><i class="fa fa-phone"></i> 0975055640</a></li>
                                    <li><a href="#"><i class="fa fa-envelope"></i> 1412436@student.hcmus.edu.vn</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-8">
                            <div class="shop-menu pull-right">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="${pageContext.request.contextPath}/total/checklogin"><i class="fa fa-lock"></i> Log out</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="mainmenu pull-left">
                                <ul class="nav navbar-nav collapse navbar-collapse">
                                    <li><a href="${pageContext.request.contextPath}/total/listManager" class="active">Quản lí sản phẩm</a></li>
                                    <li class="dropdown"><a href="${pageContext.request.contextPath}/total/add">Thêm sản phẩm<i class="fa fa-angle-down"></i></a>
