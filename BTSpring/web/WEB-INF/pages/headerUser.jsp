                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="mainmenu pull-left">
                                <ul class="nav navbar-nav collapse navbar-collapse">
                                    <li><a href="${pageContext.request.contextPath}/total/listUser" class="active">Home</a></li>
                                    <li class="dropdown"><a href="${pageContext.request.contextPath}/total/thongtin">Xem thông tin cá nhân<i class="fa fa-angle-down"></i></a>
